...
export async function POST(request: Request) {
  try {
    ...
    const avatarId =
      ...
      "6824a3e0-f37f-455a-b1d4-3140111a83bf";
    ...
    const session = await startSession({
      roomName,
      avatarId,
      startProcesses: body.startProcesses === true,
      maxDurationSeconds: body.maxDurationSeconds,
      publishAudio: body.publishAudio === true,
      requireTurn: body.requireTurn === true,
      audioDelaySeconds: body.audioDelaySeconds,
